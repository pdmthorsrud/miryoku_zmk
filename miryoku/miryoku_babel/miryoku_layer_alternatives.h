...
&kp LBRC,          &kp LS(N2),          &kp LS(LA(N8)),         &kp LS(LA(N9)),          &kp LS(N7),          U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp COLON,         &kp SINGLE_QUOTE,          &kp LS(N8),         &kp LS(N9),         &kp UNDERSCORE,          U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
